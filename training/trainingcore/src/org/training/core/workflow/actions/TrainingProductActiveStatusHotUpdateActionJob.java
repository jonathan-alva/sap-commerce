...
public class TrainingProductActiveStatusHotUpdateActionJob extends AbstractTrainingProductActionStatusApprovalActionJob{
    ...
    private boolean callSyncAction(final ProductModel productModel) {
        try {
            ...
            LOGGER.debug("Entered into Training Product Active Status Hot Update" + e);
            return false;
        } finally {
